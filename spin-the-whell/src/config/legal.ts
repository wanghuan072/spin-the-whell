...
export const LEGAL_PAGES: LegalPageContent[] = [
  {
    ...
    bodyHtml: `
<p>This Privacy Policy explains how Spinanywheel, presented on this site as Spin the Wheel (“we”, “our”, or “the site”), handles information when you use our free online random picker. We designed the tool to work primarily in your browser so you can create and spin a wheel without creating an account.</p>
...
<h2>Information we receive automatically</h2>
...
<p>We use Google Analytics to understand aggregate site use, such as which pages are visited, how visitors arrive, broad device and browser information, and interactions with site content. Google may process online identifiers, cookie information, IP-derived information, and event data for this purpose. We use the reports to improve the product, find broken journeys, and understand which guides are useful; we do not send your wheel option text, imported lists, or comment message contents to Google Analytics as analytics event labels.</p>
<h2>Advertising and Google AdSense</h2>
<p>We use Google AdSense technology to support advertising on the site. Google and its advertising partners may use cookies, web beacons, device identifiers, IP-derived information, and similar technologies to deliver, measure, limit, or personalize advertising, subject to your choice and applicable law. Google may use advertising cookies based on visits to this and other websites. We do not control the data practices of advertisers, advertising networks, or the websites reached through an ad.</p>
<h2>Cookies and similar technologies</h2>
<p>We use essential cookies or local storage needed for basic site functions, such as remembering a theme preference, keeping the wheel editor state, and maintaining a signed-in community session. The community session cookie is HttpOnly, is not available to page scripts, and normally expires after 30 days. Google Analytics, Google AdSense, and advertising partners may also use cookies and similar technologies as described above.</p>
<p>You can manage cookies through your browser settings. Google provides controls for personalized ads through <a href="https://myadcenter.google.com/" rel="noopener noreferrer">My Ad Center</a> and information about opting out through <a href="https://www.aboutads.info/choices/" rel="noopener noreferrer">YourAdChoices</a>. Blocking storage can limit features such as saving a wheel or posting a comment.</p>
<p>Visitors in the European Economic Area, the United Kingdom, and Switzerland may be entitled to additional consent choices before personalized advertising is served. Before we serve personalized Google ads in those regions, we will use a Google-certified consent management platform where required by Google’s EU user consent policy.</p>
<h2>Sharing of information</h2>
<p>We do not sell your personal information. We do not require an account to use the core Spin the Wheel tool. Google processes information needed to provide Google sign-in, analytics, and advertising services, while advertising partners, hosting providers, and database providers may process relevant account and technical data as needed to operate their services and the site.</p>
